...
function Feature() {
    return (
        <div class="bg-grey-50 font-[sans-serif]">
            <div class="max-w-4xl mx-auto py-10 px-3">
                <h2 class="text-orange-700 text-4xl font-extrabold text-center mb-16">Discover Our Exclusive Features</h2>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
                    <div class="bg-slate-300 rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div class="p-8">
                            ...
                            <h3 class="text-gray-800 text-xl font-semibold mb-3"></h3>
